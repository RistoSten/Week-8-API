...
window.onload = () => {
    let url = 'https://api.themoviedb.org/3/movie/343668?api_key=bdb7db716acf26f7eab2bbe6e9c9faf5'
    ...
    .then(data => {
        ...
        let posterUrl =  `https://www.themoviedb.org/t/p/w1280${data.poster_path}`;
        ...
        let genresUpdated = genresToDisplay.slice(0, -3) + '.';
